...
export default function FAQPage() {
  return (
    <div style={S.page}>
      ...
      {faqs.map((f, i) => (
        <div key={i} style={{ marginBottom: 28, padding: '24px 28px', background: 'var(--bg-card)', borderRadius: 16, border: '1px solid var(--border)' }}>
          <h3 style={{ fontSize: 18, fontWeight: 800, marginBottom: 10, color: 'var(--text-primary)' }}>{f.q}</h3>
