...
export default function ForgotPasswordPage() {
  ...
  return (
    <div style={{ background: 'var(--bg-page)', minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: 'Outfit, sans-serif', color: 'var(--text-primary)' }}>
      ...
      <style>{`
        .auth-forgot-card input:focus { box-shadow: 0 0 0 2px #5A31F4; border-color: #5A31F4 !important; outline: none; }
      ...
      `}</style>
      <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} className="auth-forgot-card"
