...
function BusinessPortalForm() {
  ...
  // Signup state — pre-fill from URL params if coming from business inquiry
  ...
  return (
    <div style={{ position: 'relative', zIndex: 1, width: '100%', maxWidth: 520 }}>
      ...
      {/* Role indicator */}
      <div style={{ background: 'rgba(90,49,244,0.08)', border: '1px solid rgba(90,49,244,0.2)', borderRadius: 12, padding: '10px 16px', marginBottom: 20, textAlign: 'center' }}>
        <span style={{ fontSize: 13, color: '#5A31F4', fontWeight: 600 }}>🏢 Dit portaal is voor zakelijke klanten van EnJoy</span>
      </div>
